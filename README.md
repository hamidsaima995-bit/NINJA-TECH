...
- **Design Philosophy:** Modern 3D Web Agency Style, Responsive UI/UX
- **Deployment:** Live on Railway

## 📂 Project Structure
- `index.html`: Main landing page
- `services.html`: Detailed service breakdown
- `portfolio.html`: Showcase of live applications
- `about.html`: Professional bio
- `team.html`: Team/Founder overview
- `contact.html`: Inquiry form
- `style.css`: Core design and custom animations

## 📬 Contact
- Feel free to reach out for collaborations or project inquiries!
- **Portfolio:** [Link to your Live Railway URL]
